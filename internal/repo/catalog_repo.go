...
func (c *CatalogRepo) AllFindByNumber(ctx context.Context, number int) ([]*entity.Catalog, error) {
	rows, err := c.mssql.QueryContext(ctx, FGWCatalogAllFindByNumberQuery, number)
	if err != nil {
		c.wLogg.LogE(msg.E3000, err)
